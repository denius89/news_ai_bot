...
class FeedbackTracker:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self.reaction_weights = {"like": 1.0, "dislike": -0.5, "fire": 2.0, "bored": -1.0}
    ...
    async def _get_message_reactions(self, message_id: int, chat_id: int) -> Dict[str, int]:
        ...
        try:
            ...
            reactions = {"like": 0, "dislike": 0, "fire": 0, "bored": 0}
    ...
    async def _save_feedback_to_database(self, reaction_data: ReactionData) -> None:
        ...
        try:
            ...
            logger.info(
                f"Saving feedback for digest {reaction_data.digest_id}: "
    ...
    async def _trigger_ai_update(self, reaction_data: ReactionData) -> None:
        ...
        try:
            ...
            logger.info(
                f"Triggering AI update for digest {reaction_data.digest_id} "
    ...
    def get_top_engaging_categories(self, limit: int = 3) -> List[Tuple[str, float]]:
        ...
        try:
            ...
            mock_categories = [("crypto", 0.85), ("tech", 0.78), ("sports", 0.72)]
