...
async def cb_subscriptions_menu(query: types.CallbackQuery):
    ...
    text = (
        ...
        "📁 <b>Категории</b> → <b>Подкатегории</b>\n"
...
async def cb_subscribe_menu(query: types.CallbackQuery):
    ...
    text = (
        ...
        "Шаг 1️⃣: Выберите <b>категорию</b>\n"
        "Шаг 2️⃣: Выберите <b>подкатегорию</b> (если есть)\n\n"
        "📁 Примеры категорий:\n"
...
async def cb_unsubscribe_menu(query: types.CallbackQuery):
    ...
    text = (
        ...
        "Выберите категорию или подкатегорию, от которой хотите отписаться.\n\n"
        "💡 <b>Совет:</b> Используйте команду /my_subs чтобы посмотреть\n"
