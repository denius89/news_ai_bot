...
def create_sample_rejected_log():
    ...
    sample_data = [
        ...
        {"category": "crypto", "source": "spamcrypto.com", "reason": "pre_filter", "title": "Free Bitcoin giveaway - click here now"},
        {"category": "tech", "source": "spamtech.blog", "reason": "pre_filter", "title": "Sponsored: Best antivirus software 2025"},
        {"category": "tech", "source": "fake-tech.com", "reason": "pre_filter", "title": "Click here to download free software"},
        {"category": "sports", "source": "sportsfake.news", "reason": "pre_filter", "title": "Click here to watch live sports streams"},
        {"category": "sports", "source": "spam-sports.io", "reason": "pre_filter", "title": "Free sports streaming - click here"},
    ]
