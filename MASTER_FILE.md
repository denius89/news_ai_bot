...
| category     | text        | Категория (crypto, economy, world, technology, politics) |
...
### Особенности
- Функция `upsert_news` сохраняет новости по уникальному `link`.  
  Если новость с таким `link` уже есть — обновляется её содержимое.  
...
## История решений
Дата | Решение | Альтернативы | Почему так | Влияние
---- | -------- | ------------- | ---------- | --------
2025-09-23 | Добавили структуру общения | вести всё в голове | проще отслеживать прогресс | повысили прозрачность
2025-09-23 | Решили добавить фильтр по темам | показывать всё подряд | фильтрация полезнее и гибче | появится персонализация дайджестов
