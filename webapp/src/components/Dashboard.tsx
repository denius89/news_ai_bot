                    ...
                    <div className="flex items-center">
                      <div className="w-32 bg-gray-200 rounded-full h-2 mr-2">
                        <div 
                          ...
                          style={{ 
                            width: `${Math.min(100, trendData.length > 0 ? (item.count / Math.max(...trendData.map(d => d.count))) * 100 : 0)}%` 
                          }}
                        ></div>
                      </div>
                    ...
                    <div className="flex items-center">
                      <div className="w-24 bg-gray-200 rounded-full h-2 mr-2">
                        <div 
                          ...
                          style={{ 
                            width: `${Math.min(100, sourcesBreakdown.length > 0 ? (item.count / Math.max(...sourcesBreakdown.map(s => s.count))) * 100 : 0)}%` 
                          }}
                        ></div>
                      </div>
                      <span className="text-sm font-medium text-gray-900 w-8 text-right">{item.count}</span>
