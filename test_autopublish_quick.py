...
async def test_autopublish_logic():
    ...
    try:
        ...
        test_digests = [
            {"id": 1, "published": False, "status": "ready", "title": "Test digest 1"},
            {"id": 2, "published": True, "status": "ready", "title": "Test digest 2 (already published)"},
            {"id": 3, "published": False, "status": "draft", "title": "Test digest 3 (not ready)"},
        ]
