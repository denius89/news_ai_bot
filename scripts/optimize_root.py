...
class RootOptimizer:
    ...
    def create_directories(self):
        ...
        directories = [self.config_dir, self.src_dir, self.archive_dir]
    ...
    def move_source_files(self):
        ...
        source_files = ["main.py", "webapp.py"]
    ...
    def move_archive_files(self):
        ...
        archive_items = ["backup_md_files", "backup_root_md_files"]
    ...
    def move_report_files(self):
        ...
        report_files = ["STRUCTURE_REORGANIZATION_REPORT.md"]
    ...
    def verify_structure(self):
        ...
        essential_files = ["README.md", "pyproject.toml", "requirements.txt", "Makefile", "LICENSE", ".gitignore"]
