...
class ToolsOptimizer:
    ...
    def create_new_structure(self):
        ...
        categories = ["management", "news", "events", "sources", "ai", "frontend", "notifications", "testing", "utils"]
    ...
    def merge_similar_files(self):
        ...
        fetch_files = ["fetch_and_store_news.py", "fetch_loop.py", "fetch_optimized.py"]
        ...
        distribute_files = ["distribute_sources.py", "smart_distribute_sources.py"]
        ...
        css_files = ["cleanup_css.py", "optimize_css.py"]
    ...
    def create_init_files(self):
        ...
        # Для tools
        tool_dirs = ["management", "news", "events", "sources", "ai", "frontend", "notifications", "testing", "utils"]
