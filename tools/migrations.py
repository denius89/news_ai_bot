...
class MigrationTool:
    ...
    def add_notifications_table(self):
        ...
        try:
            result = self.service.sync_client.table("user_notifications").select("*").limit(1).execute()
    ...
    def add_test_notifications(self, user_id: str = "test-user-123"):
        ...
        try:
            result = self.service.sync_client.table("user_notifications").insert(test_notifications).execute()
