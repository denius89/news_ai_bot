...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('logs/auto_learn.log', mode='a')
        ]
    )
...
def create_sample_rejected_log():
    ...
    sample_data = [
        {"category": "crypto", "source": "cryptoblog.fake.io", "reason": "pre_filter", "title": "Bitcoin giveaway scam - click here to claim"},
        {"category": "crypto", "source": "earnmoney.today", "reason": "pre_filter", "title": "Make money with cryptocurrency trading signals"},
        {"category": "crypto", "source": "reuters.com", "reason": "ai_below_threshold", "title": "Bitcoin price moves slightly in trading session"},
        {"category": "tech", "source": "spamtech.blog", "reason": "pre_filter", "title": "Sponsored: Best antivirus software 2025"},
        {"category": "tech", "source": "techcrunch.com", "reason": "ai_below_threshold", "title": "Minor bug fix released for popular app"},
        {"category": "sports", "source": "sportsfake.news", "reason": "pre_filter", "title": "Click here to watch live sports streams"},
        {"category": "sports", "source": "espn.com", "reason": "duplicate", "title": "Football match results from yesterday"},
        {"category": "world", "source": "worldnews.fake", "reason": "pre_filter", "title": "Breaking: You won't believe what happened"},
    ]
