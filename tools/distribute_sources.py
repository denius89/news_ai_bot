...
def distribute_sources_to_subcategories():
    ...
    distribution = {
        # Crypto
        'crypto/defi': ['defi', 'defi protocol', 'uniswap', 'compound', 'aave', 'maker', 'curve', 'yearn'],
        'crypto/ethereum': ['ethereum', 'eth', 'ethereum network', 'eth2', 'eth2.0', 'shanghai', 'merge'],
        'crypto/exchanges': ['exchange', 'binance', 'coinbase', 'kraken', 'bitfinex', 'kucoin', 'huobi', 'okx'],
        'crypto/gamefi': ['gamefi', 'gaming', 'nft gaming', 'play to earn', 'axie', 'sandbox', 'decentraland'],
        'crypto/market_trends': ['market', 'price', 'bull', 'bear', 'rally', 'crash', 'analysis', 'trend'],
        ...
        'markets/central_banks': ['fed', 'federal reserve', 'ecb', 'central bank', 'interest rate', 'monetary policy'],
        'markets/commodities': ['gold', 'silver', 'oil', 'gas', 'commodity', 'crude', 'wti', 'brent'],
        'markets/earnings': ['earnings', 'quarterly', 'revenue', 'profit', 'eps', 'guidance'],
        'markets/economic_data': ['gdp', 'inflation', 'cpi', 'ppi', 'unemployment', 'economic indicator'],
        'markets/forex': ['forex', 'fx', 'currency', 'dollar', 'euro', 'yen', 'pound', 'usd', 'eur'],
        ...
        'sports/football': ['football', 'soccer', 'premier league', 'champions league', 'world cup'],
        ...
        'tech/conferences': ['conference', 'summit', 'tech conference', 'ces', 'wwdc', 'google i/o'],
        ...
        # World
        'world/climate': ['climate', 'global warming', 'carbon', 'renewable', 'sustainability', 'green'],
        ...
        'world/geopolitics': ['geopolitics', 'international relations', 'diplomacy', 'foreign policy'],
        'world/global_risks': ['risk', 'threat', 'security', 'terrorism', 'cyber attack', 'pandemic'],
