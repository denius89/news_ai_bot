...
def test_ai_filters_and_auto_learning():
    ...
    try:
        ...
        if cached_result:
            importance, credibility, summary = cached_result.ai_importance, cached_result.ai_credibility, cached_result.ai_summary
...
def test_configuration_files():
    ...
    try:
        ...
        # Test data files
        data_files = [
            'data/self_tuning_dataset.csv',
            'data/pulseai_dataset.csv'
        ]
