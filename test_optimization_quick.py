...
def test_optimization_system():
    ...
    # Test news items
    test_news = [{"title": "SEC approves Bitcoin ETF in major regulatory breakthrough for cryptocurrency markets",
    ...
    for i, news in enumerate(test_news):
        ...
        if entry:
            print(
                f"      → Now cached: importance={entry.ai_importance}, credibility={entry.ai_credibility}")
    print()
