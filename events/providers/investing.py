        ...
        if date.weekday() < 5:
            ...
            if date.day % 7 == 1:  # First week of month
                events.append(Event(
                    ...
                    starts_at=datetime.combine(date, datetime.min.time().replace(hour=12, minute=30)).replace(tzinfo=timezone.utc),
                    ends_at=None,
            ...
            if date.day <= 7 and date.month % 2 == 0:  # First week of even months
                events.append(Event(
                    ...
                    starts_at=datetime.combine(date, datetime.min.time().replace(hour=18, minute=0)).replace(tzinfo=timezone.utc),
                    ends_at=None,
                    source="investing.com",
                    link="https://www.investing.com/economic-calendar/",
                    importance=0.95,
            ...
            if date.day <= 7 and date.month % 2 == 1:  # First week of odd months
                events.append(Event(
                    ...
                    category="markets",
                    subcategory="monetary_policy",
                    starts_at=datetime.combine(date, datetime.min.time().replace(hour=12, minute=45)).replace(tzinfo=timezone.utc),
                    ends_at=None,
                    source="investing.com",
                    link="https://www.investing.com/economic-calendar/",
                    importance=0.9,
