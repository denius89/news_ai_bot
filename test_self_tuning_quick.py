    ...
    sample_data = [
        {
            ...
            "title": "Bitcoin price rises as institutional adoption increases",
        },
        {
            "category": "crypto",
            "source": "bloomberg.com",
            "reason": "ai_below_threshold",
            "title": "Ethereum upgrade brings new features to blockchain",
        },
        {
            "category": "tech",
        ...
        },
        {
            ...
            "source": "espn.com",
            "reason": "ai_below_threshold",
            "title": "Championship game set for next weekend",
        },
        {
            "category": "sports",
            "source": "nfl.com",
            "reason": "ai_below_threshold",
            "title": "Player transfer creates buzz in league",
        },
        {
            "category": "world",
            "source": "bbc.com",
...
def test_self_tuning_system():
    ...
    try:
        ...
        for i, item in enumerate(test_items, 1):
            ...
            print(
                f"   Test {i}: importance={prediction.importance:.3f}, credibility={prediction.credibility:.3f}, confidence={prediction.confidence:.3f}"
            )
    ...
    try:
        ...
        if predictor.self_tuning_enabled and predictor.self_tuning_trainer:
            try:
                ...
                print(
                    f"ML model:    importance={ml_prediction.importance:.3f}, credibility={ml_prediction.credibility:.3f}"
                )
