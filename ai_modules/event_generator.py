...
class EventGenerator:
    ...
    def __init__(self):
        ...
        self.event_patterns = {
            'crypto': {
                'upgrade_patterns': [
                    'plans to upgrade', 'scheduled for upgrade', 'upgrade roadmap',
                    'network improvement', 'protocol enhancement'
                ],
                'launch_patterns': [
                    'will launch', 'planning to release', 'scheduled launch',
                    'coming soon', 'expected to debut'
                ],
                'listing_patterns': [
                    'applying for listing', 'seeking exchange approval',
                    'partnership with exchange', 'trading approval pending'
                ]
            },
            'markets': {
                'policy_patterns': [
                    'considering rate change', 'policy review', 'monetary decision',
                    'economic stimulus', 'regulatory proposal'
                ],
                'data_patterns': [
                    'economic data release', 'quarterly results', 'earnings report',
                    'inflation data', 'employment statistics'
                ]
            },
            'tech': {
                'release_patterns': [
                    'product launch', 'feature release', 'beta testing',
                    'version update', 'new technology'
                ],
                'partnership_patterns': [
                    'strategic partnership', 'collaboration agreement',
                    'technology integration', 'joint venture'
                ]
            }
        }
