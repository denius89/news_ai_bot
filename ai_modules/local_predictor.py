...
class LocalPredictor:
    ...
    def __init__(self, config_path: str = None):
        ...
        self.credibility_positive = [
            'official', 'confirmed', 'verified', 'announced', 'reported',
            'according to', 'sources say', 'confirmed by', 'verified by'
        ]
        
        self.credibility_negative = [
            'rumor', 'alleged', 'unconfirmed', 'speculation', 'possibly',
            'might be', 'could be', 'unverified', 'hearsay'
        ]
    ...
    def _extract_word_features_for_ml(self, title: str, content: str) -> Dict[str, float]:
        ...
        # Word frequency features
        important_words = [
            'breaking', 'urgent', 'exclusive', 'analysis', 'report',
            'official', 'confirmed', 'announced', 'released', 'launched'
        ]
        
        spam_words = [
            'click', 'here', 'free', 'giveaway', 'scam', 'sponsored',
            'advertisement', 'advertorial', 'opinion', 'prediction'
        ]
