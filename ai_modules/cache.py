...
class AICache:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self.key_format = self.config.get('cache', {}).get('dedup_key_format', 
                                                          "{title_norm}|{link_norm}|{source}|{date_yyyy_mm_dd}")
    ...
    def set(self, news_item: Dict, importance: float, credibility: float, 
            summary: Optional[str] = None, model: str = "gpt-4o-mini") -> None:
        """
    ...
    def update_partial(self, news_item: Dict, importance: Optional[float] = None, 
                      credibility: Optional[float] = None, summary: Optional[str] = None) -> None:
        """
...
def cache_evaluation(news_item: Dict, importance: float, credibility: float,
                    summary: Optional[str] = None, model: str = "gpt-4o-mini") -> None:
    """
