...
class EventForecastEngine:
    ...
    def _assess_market_reaction(
        ...
        if importance >= 0.8:
            ...
            reaction = reactions[1] if len(reactions) > 1 else reactions[0] if reactions else "Умеренное влияние на рынки."
        else:
            reaction = reactions[2] if len(reactions) > 2 else reactions[0] if reactions else "Ограниченное влияние на рынки."
    ...
    def _identify_opportunities(
        ...
        if category == 'crypto':
            opportunities.extend([
                "Раннее инвестирование в новые технологии",
                "DeFi и NFT возможности"
            ])
        elif category == 'markets':
            opportunities.extend([
            ...
            opportunities.extend([
                "Спортивные ставки и аналитика",
                "Медиа и рекламные возможности"
            ])
        elif category == 'tech':
            opportunities.extend([
