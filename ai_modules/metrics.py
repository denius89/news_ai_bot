        ...
        with self.metrics._lock:
            ...
            if total_forecasts > 0:
                self.metrics.event_forecast_confidence_avg = (
                    current_avg * (total_forecasts - 1) + confidence
                ) / total_forecasts
            else:
